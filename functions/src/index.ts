...
export const search = functions.https.onRequest(async (request, response) => {
    requestify.get(`https://darkbyte.ent.europe-north1.gcp.elastic-cloud.com:443/api/as/v1/engines/darkbyte/search?auth_token=${process.env.SEARCH_TOKEN}&query=${request.body.query}`)
